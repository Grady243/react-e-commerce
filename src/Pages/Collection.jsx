...
import collectionbg from "../assets/collectionbg.jpg";
...
export default function Collection() {
  ...
  useEffect(() => {
    if (selectedCollection === "All") {
      ...
      setProducts(allProducts.filter(p => p.collection === selectedCollection));
    }
  }, [selectedCollection]);
      ...
      <div className="px-10 md:px-24 py-20">
        ...
        {products.length === 0 ? (
          <div className="bg-white rounded-lg shadow p-12 text-center">
            <p className="text-gray-600">Aucun produit dans cette collection.</p>
          </div>
        ) : (
